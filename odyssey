...
local window = AddWindow() -- Initialize menu
do -- random
    local aimbot_tab = window:AddTab({name = "combat"}) -- TAB
    aimbot_tab:AddTab({name = "legitbot"})  -- SUBTAB
    ...
    section0:AddDropdown({name = "target selection"})
    section0:AddDropdown({name = "hitboxes"})
    ...
    aimbot_tab:AddTab({name = "triggerbot"})  -- SUBTAB
    aimbot_tab:AddTab({name = "other"})  -- SUBTAB
end
